...
function CoffeScreen({ route }) {
  ...
  return (
    <View style={styles.rootContainer}>
      <Progress firstProgress={1} secondProgress={1} thirdProgress={0.7} />
