...
function FlightToScreen({ route, navigation }) {
  ...
  return (
    <View style={styles.rootContainer}>
      ...
      <View style={styles.mainContainer}>
        <Question number={questionId}>Care este orașul destinție?</Question>
        <AnswerDropdown
          flightId={flightId}
          questionId={questionId}
